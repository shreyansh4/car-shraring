...
if (isset($_POST["create"])) {
    ...
    if (!$result) {
        echo "<script> alert('ERROR: Email is already exists')</script>";
    } else {
        header("index.php");
...
if (isset($_POST["login"])) {
    ...
    if ($rowcount == true) {
        ...
        echo "<script> alert('ERROR: Password is incorrect...')</script>";
    }
}
...
<head>
    ...
    <style>
        ...
        * {
        ...
        #login .container .mainbox .text h2 {
...
<body>
    <header>
        <nav>
            <!-- <label class="logo" style="font-family: 'Berkshire Swash', cursive;font-size: 30px; ">Car Sharing</label> -->
            <label class="logo"><img src="../images/college logo.png" height="40px" width="200px"></a></li></label>

            <ul class="nav-ul">
                <li class="nav-li"><a class="sidea1" href="#signin">SIGNIN</a></li>
                <li class="nav-li"><a class="sidea1" href="#signup">SIGNUP</a></li>
        ...
        <div class="container">
            <div class=" mainbox signinBx page join_box" id="signin">
                <form method="POST">
                    ...
                    <p class="signup" style="margin-top: 10px;">Don't have an account ? <a class="sidea1" href="#signup">Sign Up.</a></p>
                </form>
            </div>
            ...
            <div class="mainbox signupBx page create_box" id="signup" style="display:none">
                ...
                <form method="POST">
                    ...
                    <div class="flex-container">
                        <div class="inputbox">
                            <input type="text" name="phone_no" pattern="[6-9]{1}[0-9]{9}" title="Phone number with 6-9 and remaing 10 digit with 0-9" class="flex-item-left" required>
                            <span>Number</span>
                        </div>
                        <div class="inputbox">
                    ...
                    <div class="inputbox">
                        <input type="password" name="password" class="input-control" id="pwd" name="pwd" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                        <span>Password</span>
                    </div>
